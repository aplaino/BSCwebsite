...
export default function Catering() {
  ...
  return (
    <main
      className="bg-[url(./catering-background.svg)] bg-cover
        px-6 
        w-full min-h-screen pt-40 pb-20 flex flex-col gap-10 justify-center items-center"
    >
      <article
      ...
      >
        ...
        <select name="serviceType">
          <option value="FOOD_TRUCK">
            Food Truck Catering (20 ft parking spots and that's it! We will take
            it from there)
          </option>
          ...
          <option value="FULL_SERVICE">
            Full-Service Drop Off (Buffet Style setup with chefs on hand serving
            food)
          </option>
        </select>
